...
private:
	const cpp_base::scene::SelectSceneDesc *desc_;
	UINT progress_type_;
...
public:
	...
	const cpp_base::scene::SelectSceneDesc *GetDesc(void) const;
};
}
}
 ...
 * @return desc (desc)
 */
inline const cpp_base::scene::SelectSceneDesc *cpp_base::scene::SelectScene::GetDesc(void) const
{
	return (this->desc_);
}
