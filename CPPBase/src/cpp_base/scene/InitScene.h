...
private:
	const cpp_base::scene::InitSceneDesc *desc_;
	UINT progress_type_;
...
public:
	...
	const cpp_base::scene::InitSceneDesc *GetDesc(void) const;
};
}
}
 ...
 * @return desc (desc)
 */
inline const cpp_base::scene::InitSceneDesc *cpp_base::scene::InitScene::GetDesc(void) const
{
	return (this->desc_);
}
