...
private:
	const cpp_base::scene::TitleSceneDesc *desc_;
	UINT progress_type_;
...
public:
	...
	const cpp_base::scene::TitleSceneDesc *GetDesc(void) const;
};
}
}
 ...
 * @return desc (desc)
 */
inline const cpp_base::scene::TitleSceneDesc *cpp_base::scene::TitleScene::GetDesc(void) const
{
	return (this->desc_);
}
