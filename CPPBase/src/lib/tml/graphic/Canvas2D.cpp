 ...
 * 0未満=失敗
 */
INT tml::graphic::Canvas2D::OnCreate(void)
{
 ...
 * 0未満=失敗
 */
INT tml::graphic::Canvas2D::OnCreateDeferred(void)
{
 ...
 * @param desc (desc)
 */
void tml::graphic::Canvas2D::OnSetDesc(const tml::ManagerResourceDesc *desc)
{
	this->desc_ = dynamic_cast<const tml::graphic::Canvas2DDesc *>(desc);
