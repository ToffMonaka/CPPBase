/**
 * @file
 * @brief ShadowCameraShaderStructuredBufferコードファイル
 */
 ...
 * @brief コンストラクタ
 */
tml::graphic::ShadowCameraShaderStructuredBufferDesc::ShadowCameraShaderStructuredBufferDesc()
{
	return;
}
 ...
 * @brief 初期化関数
 */
void tml::graphic::ShadowCameraShaderStructuredBufferDesc::Init(void)
{
 ...
 * @brief コンストラクタ
 */
tml::graphic::ShadowCameraShaderStructuredBuffer::ShadowCameraShaderStructuredBuffer() :
 ...
 * @brief Release関数
 */
void tml::graphic::ShadowCameraShaderStructuredBuffer::Release(void)
{
 ...
 * @brief 初期化関数
 */
void tml::graphic::ShadowCameraShaderStructuredBuffer::Init(void)
{
	this->Release();
 ...
 * 0未満=失敗
 */
INT tml::graphic::ShadowCameraShaderStructuredBuffer::Create(const tml::graphic::ShadowCameraShaderStructuredBufferDesc &desc)
{
	this->Init();

	if (tml::graphic::ShaderStructuredBuffer::Create(desc, sizeof(tml::graphic::ShadowCameraShaderStructuredBuffer::ELEMENT)) < 0) {
		this->Init();

		return (-1);
	}

	this->element_ary_ = tml::MemoryUtil::Get<tml::graphic::ShadowCameraShaderStructuredBuffer::ELEMENT>(desc.element_limit);
 ...
 */
/*
void tml::graphic::ShadowCameraShaderStructuredBuffer::SetElement(const UINT index, tml::graphic::ShadowCamera *light, const bool draw_shadow_flg, const XMMATRIX &v_mat)
{
