 ...
 */
inline INT &tml::RandomUtilEngine::GetValue(INT &dst_val)
{
	dst_val = this->GetINT();
 ...
 * @return dst_val (dst_value)
 */
inline INT &tml::RandomUtilEngine::GetValue(INT &dst_val, const INT min_val, const INT max_val)
{
 ...
 * @return dst_val (dst_value)
 */
inline UINT &tml::RandomUtilEngine::GetValue(UINT &dst_val)
{
 ...
 * @return dst_val (dst_value)
 */
inline UINT &tml::RandomUtilEngine::GetValue(UINT &dst_val, const UINT min_val, const UINT max_val)
{
 ...
 * @return dst_val (dst_value)
 */
inline LONGLONG &tml::RandomUtilEngine::GetValue(LONGLONG &dst_val)
{
 ...
 * @return dst_val (dst_value)
 */
inline LONGLONG &tml::RandomUtilEngine::GetValue(LONGLONG &dst_val, const LONGLONG min_val, const LONGLONG max_val)
{
 ...
 * @return dst_val (dst_value)
 */
inline ULONGLONG &tml::RandomUtilEngine::GetValue(ULONGLONG &dst_val)
{
 ...
 * @return dst_val (dst_value)
 */
inline ULONGLONG &tml::RandomUtilEngine::GetValue(ULONGLONG &dst_val, const ULONGLONG min_val, const ULONGLONG max_val)
{
 ...
 * @return dst_val (dst_value)
 */
inline FLOAT &tml::RandomUtilEngine::GetValue(FLOAT &dst_val)
{
 ...
 * @return dst_val (dst_value)
 */
inline FLOAT &tml::RandomUtilEngine::GetValue(FLOAT &dst_val, const FLOAT min_val, const FLOAT max_val)
{
 ...
 * @return dst_val (dst_value)
 */
inline DOUBLE &tml::RandomUtilEngine::GetValue(DOUBLE &dst_val)
{
 ...
 * @return dst_val (dst_value)
 */
inline DOUBLE &tml::RandomUtilEngine::GetValue(DOUBLE &dst_val, const DOUBLE min_val, const DOUBLE max_val)
{
