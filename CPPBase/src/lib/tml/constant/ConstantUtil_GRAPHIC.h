...
namespace GRAPHIC {
	...
	const UINT DRAW_VIEWPORT_LIMIT = D3D11_SIMULTANEOUS_RENDER_TARGET_COUNT;
	const UINT DRAW_RENDER_TARGET_LIMIT = D3D11_SIMULTANEOUS_RENDER_TARGET_COUNT;
	const UINT DRAW_DEPTH_TARGET_LIMIT = 1U;
	const UINT DRAW_SHADER_CONSTANT_BUFFER_SR_LIMIT = D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT;
	const UINT DRAW_SHADER_CONSTANT_BUFFER_UASR_LIMIT = 0U;
	const UINT DRAW_SHADER_STRUCTURED_BUFFER_SR_LIMIT = 16U;
	const UINT DRAW_SHADER_STRUCTURED_BUFFER_UASR_LIMIT = 4U;
	const UINT DRAW_CAMERA_LIMIT = 2U;
	const UINT DRAW_LIGHT_LIMIT = 128U;
	const UINT DRAW_FOG_LIMIT = 16U;
	const UINT DRAW_TEXTURE_SR_LIMIT = D3D11_COMMONSHADER_INPUT_RESOURCE_SLOT_COUNT - 16U;
	const UINT DRAW_TEXTURE_UASR_LIMIT = D3D11_PS_CS_UAV_REGISTER_COUNT - 4U;
	const UINT DRAW_SAMPLER_SR_LIMIT = D3D11_COMMONSHADER_SAMPLER_SLOT_COUNT;
	const UINT DRAW_MODEL_LIMIT = 256U;
}
}
}
