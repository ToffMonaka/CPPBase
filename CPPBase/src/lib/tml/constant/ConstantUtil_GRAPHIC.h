...
namespace GRAPHIC {
	...
	const UINT MODEL_3D_INPUT_ELEMENT_DESC_COUNT = 3U;
	const D3D11_INPUT_ELEMENT_DESC MODEL_3D_INPUT_ELEMENT_DESC_ARRAY[tml::ConstantUtil::GRAPHIC::MODEL_3D_INPUT_ELEMENT_DESC_COUNT] = {
		{"POSITION", 0U, DXGI_FORMAT_R32G32B32A32_FLOAT, 0U, 0U, D3D11_INPUT_PER_VERTEX_DATA, 0U},
		{"TEXCOORD", 0U, DXGI_FORMAT_R32G32_FLOAT, 0U, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_VERTEX_DATA, 0U},
		{"LAYER_INDEX", 0U, DXGI_FORMAT_R32_UINT, 0U, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_VERTEX_DATA, 0U}
	};
